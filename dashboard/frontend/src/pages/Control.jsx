...
//     pump: [40, 60],      // soil: [开机, 关机]
//     lamp: [300, 500],    // light: [开灯, 关灯]
//     fan_interval: 10,    // 风扇间隔
//     fan_duration: 5      // 风扇单次开启时间
//   });
...
//     sendToBackend(pins[0], vals[0]); // 开机阈值
//     sendToBackend(pins[1], vals[1]); // 关机阈值
//   };
